...
description: Use domain-first modeling and keep business rules out of controller and infrastructure seams.
mcp_server: internal-tools
mcp_tool: use_workflow
mcp_workflow: domain-driven-design
mcp_repo: freetool
...
- `workflow_name="domain-driven-design"`
- `repo_name="freetool"`
